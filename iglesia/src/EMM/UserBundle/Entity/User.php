...
protected $tasks;
 protected $archivos;   
     ...
     * Add archivos
     *
     * @param \EMM\UserBundle\Entity\Archivo $archivos
     * @return User
     */
    public function addArchivo(\EMM\UserBundle\Entity\Archivo $archivos)
    {
     ...
     * @param \EMM\UserBundle\Entity\Archivo $archivos
     */
    public function removeArchivo(\EMM\UserBundle\Entity\Archivo $archivos)
    {
